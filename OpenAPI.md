# YOSGO OpenAPI Specification
[![Build Status](https://travis-ci.org/yosgo-open-source/yosgo-docs.svg?branch=master)](https://travis-ci.org/yosgo-open-source/yosgo-docs)
...
6. If you did everything correct, https://yosgo-open-source.github.io/yosgo-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://yosgo-open-source.github.io/yosgo-docs/
- SwaggerUI: https://yosgo-open-source.github.io/yosgo-docs/swagger-ui/
- Look full spec:
    + JSON https://yosgo-open-source.github.io/yosgo-docs/swagger.json
    + YAML https://yosgo-open-source.github.io/yosgo-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://yosgo-open-source.github.io/yosgo-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://yosgo-open-source.github.io/yosgo-docs/ with url from the message: `Server started <url>`
